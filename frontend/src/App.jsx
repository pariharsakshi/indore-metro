...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: 800, margin: "auto", fontFamily: "Segoe UI, sans-serif", padding: 20, background: "linear-gradient(to bottom right, #e0f7fa, #f1f8e9)", minHeight: "100vh" }}>
      <h1 style={{ textAlign: "center", fontSize: "2.5rem", marginBottom: 40, color: "#006064" }}>
